...
void PGB_init(void)
{
    ...
    PGB_App->selectorBackground =
        playdate->graphics->getTableBitmap(PGB_App->selectorBitmapTable, 0);
    PGB_App->selectorButton =
        playdate->graphics->getTableBitmap(PGB_App->selectorBitmapTable, 1);
    PGB_App->selectorFilledButton =
        playdate->graphics->getTableBitmap(PGB_App->selectorBitmapTable, 2);
...
__attribute__((optimize("Ofast"))) void PGB_update(float dt)
{
    PGB_App->dt = dt;
