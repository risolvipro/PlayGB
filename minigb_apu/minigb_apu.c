...
__attribute__((optimize("Ofast"))) static void update_env(struct chan *c)
{
...
static void update_square(int16_t *left, int16_t *right, const bool ch2,
                          int len)
{
...
void audio_init(void)
{
    ...
    {
        static const uint8_t regs_init[] = {0x80, 0xBF, 0xF3, 0xFF, 0x3F, 0xFF,
    ...
    {
        static const uint8_t wave_init[] = {0xac, 0xdd, 0xda, 0x48, 0x36, 0x02,
 ...
 */
__attribute__((optimize("O3"))) int audio_callback(void *context, int16_t *left,
